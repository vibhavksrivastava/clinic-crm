          ...
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            <div className="flex items-center gap-3 lg:gap-10">
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition hover:bg-slate-100 lg:hidden"
              >
                {mobileMenuOpen ? (
                  <X size={20} />
                ) : (
                ...
                {navLinks.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.href}
                      href={item.href}
                      className={`group flex items-center gap-2 rounded-2xl px-4 py-2 text-sm font-semibold transition-all duration-200 ${
                        isActive(item.href)
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition hover:bg-slate-100 xl:hidden"
              >
                <Search size={18} />
              </button>
              ...
              <button className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 transition hover:bg-slate-100">
                <Bell size={18} />
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-2 py-2 transition hover:bg-slate-50"
                >
          ...
          <div className="fixed left-0 top-0 z-50 h-full w-[320px] overflow-y-auto border-r border-slate-200 bg-white shadow-2xl lg:hidden">
            ...
            <div className="border-t border-slate-200 p-4">
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-2xl bg-red-500 px-4 py-4 font-semibold text-white transition hover:bg-red-600"
              >
                <LogOut size={18} />
