...
export default function ViewGoodsReceivedpage() {

const [grn, setGrn] =
  useState<GRNDetail | null>(null);
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6 mb-6 print:shadow-none">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 print:hidden">
            ...
            <button
              onClick={() => window.open(`/api/print/grn/${params.id}`, '_blank')}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-6 mb-6 print:shadow-none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <p className="font-bold text-lg text-slate-800 mt-1">
              {grn?.purchase_orders?.supplier?.supplier_name || '-'}
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <p className="font-semibold text-slate-700 mt-1">
              {grn?.purchase_orders?.supplier?.contact_person || '-'}
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <p className="font-semibold text-slate-700 mt-1">
              {grn?.purchase_orders?.supplier?.phone || '-'}
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-4">
            ...
            <p className="font-semibold text-slate-700 mt-1 break-words">
              {grn?.purchase_orders?.supplier?.address || '-'}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="w-full sm:w-96 ml-auto space-y-3">
            ...
            <div className="flex justify-between text-slate-600">
              ...
              <span className="font-medium">
                ₹
                {Number(
                  (grn?.total_amount || 0) - (grn?.gst_amount || 0)
                ).toFixed(2)}
              </span>
            </div>
